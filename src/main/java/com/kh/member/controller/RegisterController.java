...
public class RegisterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// getParameter() 메소드의 전달값은 register.jsp에서 input태그의 name의 속성값이여야 합니다. 이때 오타
		// 주의해야합니다.
		// 9개의 변수에 저장한 값은 하나의 변수로 다루기 위해 Member 인스턴스를 생성합니다. 매개변수 있는 생성자를 이용해서
		// 초기화를 해주면서 객체 생성을 합니다.
		...
		Member member = new Member(memberId, memberPw, memberName, memberGender.charAt(0), Integer.parseInt(memberAge),
